  ...
  return (
    <main className="page-shell">
      <section className="hero">
        <p className="eyebrow">Generated by Embr</p>
        <h1>{appTitle}</h1>
...
<body>
  <main class="shell">
    ...
    <section class="content">
      <div class="card"><strong>Dashboard</strong><p>Starter workspace generated by Embr.</p></div>
...
async function generateCustomPage({
  ...
  const instructions = `
You are Embr's custom app page generator.
  ...
  try {
    ...
    if (!usageStatus.allowed) {
      return apiTooManyRequests("Monthly usage limit reached.", {
        output:
          "You’ve reached your monthly Embr usage limit. Upgrade or wait until usage resets.",
    ...
    if (validationErrors.length > 0) {
      return apiServerError("Generated template failed validation.", {
        output:
          "Embr generated an app template, but it failed validation before saving.",
        validationErrors,
      });
    }
    ...
    return apiOk({
      ...
      assumptions: [
        shouldUseCleaningCrmTemplate(prompt)
          ? "Used Embr's known-good cleaning CRM template."
          : "Used Embr's hybrid app generator with a stable Next.js scaffold and AI-generated app page.",
      ],
